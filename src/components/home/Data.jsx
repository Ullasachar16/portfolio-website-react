...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Ullas Achar
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home_description">I'm creative Web Developer based in Bengaluru, and I'm very passionate and dedicated to my work.</p>
